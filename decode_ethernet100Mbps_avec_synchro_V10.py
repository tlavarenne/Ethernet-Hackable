...
# Fichiers binaires Rhode & Schwartz: JMF
f1 = 'RefCurve_2025-04-10_0_132754.Wfm.bin'  # f1, f2, fs = 500e6, une voie deinterleave= None
f2 = 'RefCurve_2025-04-10_1_132807.Wfm.bin'
...
# Lire et charger fichier binaire JMF
#periode_echantillon, donnees = lire_donnees_bin(f1, fs=1e9, dtype=np.float32, count=None, deinterleave=2)
#periode_echantillon, donnees = lire_donnees_bin(f4, fs=500e6, dtype=np.float32, count=None, deinterleave=None)

# Lire et charger fichier CSV
periode_echantillon, donnees = lire_donnees_CSV(csv1)
